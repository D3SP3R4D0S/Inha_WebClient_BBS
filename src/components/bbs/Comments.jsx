...
import { addDoc, collection, getFirestore, onSnapshot,
    orderBy, where, query, deleteDoc, doc, updateDoc } from 'firebase/firestore';
...
const Comments = () => {
    ...
    const onClickSave = async(com) => {
        ...
        if(com.text !== com.contents){
            if(!window.confirm('변경된 사항을 저장하시겠습니까?')) return;
